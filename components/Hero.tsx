            ...
            <div className="lg:w-3/5 space-y-8 text-center lg:text-left z-20">
              ...
              <div className="space-y-4">
                ...
                <h2 className="text-lg text-brand-medium max-w-2xl mx-auto lg:mx-0 leading-relaxed font-normal">
                  Consulte regras atualizadas do <strong>Bolsa Família 2025</strong>, calendário de pagamentos, <strong>BPC/LOAS</strong> e inscrição no <strong>CadÚnico</strong>. Informação clara, segura e gratuita.
                </h2>
              </div>
