...
const REGIONAL_PROGRAMS: StateProgram[] = [
  ...
  },
  {
    ...
    category: 'Transporte',
    status: 'Encerrado',
    description: 'Programa encerrado para 2024. Previsão de novo edital em Março de 2025.',
    internalRoute: 'landing-cnh'
  },
  {
    id: 'chapeu-palha-pe',
...
export const BenefitsByStatePage: React.FC<Props> = ({ onNavigate }) => {
  ...
  useEffect(() => {
    document.title = "Benefícios por Estado: Programas Sociais da sua Região | Guia 2025";
    window.scrollTo(0,0);
  }, []);
