...
export const InsurancePage: React.FC<Props> = ({ onQuote }) => {
  // SEO Optimization
  useEffect(() => {
    document.title = "Seguro Popular: Vida, Funeral e Moto a partir de R$ 5,00/mês";
    
    const metaDesc = document.querySelector('meta[name="description"]');
    const desc = "Proteja sua família por centavos ao dia. Seguro de vida com auxílio funeral completo, sorteios mensais de R$ 10 mil e telemedicina grátis. Confira!";
    if (metaDesc) {
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
           {INSURANCE_OPTIONS.map((ins) => (
              <div key={ins.id} className="group border border-gray-200 hover:border-blue-500 rounded-2xl p-6 transition-all hover:shadow-xl bg-white flex flex-col relative overflow-hidden">
