...
export const QuizBeneficiosPage: React.FC<Props> = ({ onNavigate, quizzes }) => {
  ...
  return (
    ...
    >
      ...
      <p>Nossa ferramenta de verificação cruza seus dados básicos (idade, renda aproximada e composição familiar) com as regras atualizadas de 2025.</p>
    </BroadcastLayout>
  );
};
...
export const BrasilSorridentePrivadoPage: React.FC<Props> = ({ onNavigate, quizzes }) => {
  useEffect(() => { document.title = "Brasil Sorridente 2025: Tratamento de Qualidade Gratuito"; }, []);
  return (
    <BroadcastLayout
...
export const BrasilSorridenteOdontoPage: React.FC<Props> = ({ onNavigate, quizzes }) => {
  useEffect(() => { document.title = "Cobertura Odontológica SUS 2025: O que está incluso?"; }, []);
  return (
    <BroadcastLayout
      title="Implante e Aparelho: O que o SUS cobre de verdade em 2025?"
...
export const BeneficiosFamiliaPage: React.FC<Props> = ({ onNavigate, quizzes }) => {
  useEffect(() => { document.title = "Benefícios para Famílias 2025: Guia Unificado"; }, []);
  return (
    <BroadcastLayout
      title="Pacote de Proteção à Família: Todos os auxílios disponíveis em 2025"
...
export const AuxilioReconstrucaoPage: React.FC<Props> = ({ onNavigate, quizzes }) => {
  useEffect(() => { document.title = "Auxílio Reconstrução 2025: Quem tem direito aos R$ 5.100"; }, []);
  return (
    <BroadcastLayout
...
export const AuxilioMaeSolteiraPage: React.FC<Props> = ({ onNavigate, quizzes }) => {
  useEffect(() => { document.title = "Benefício para Mães Solteiras 2025: Valores e Regras"; }, []);
  return (
    <BroadcastLayout
...
export const AuxilioGasPage: React.FC<Props> = ({ onNavigate, quizzes }) => {
  useEffect(() => { document.title = "Vale Gás 2025: Calendário e Valor Atualizado"; }, []);
  return (
    <BroadcastLayout
      title="Auxílio Gás 2025: Calendário de Pagamentos e Valor de 100%"
...
export const AuxilioCombustivelPage: React.FC<Props> = ({ onNavigate, quizzes }) => {
  useEffect(() => { document.title = "Auxílio Taxista e Caminhoneiro 2025: Situação Atual"; }, []);
  return (
    <BroadcastLayout
      title="Auxílio Combustível: O benefício para motoristas vai voltar em 2025?"
    ...
    >
      <p>O Auxílio Taxista e o Auxílio Caminhoneiro foram benefícios emergenciais criados em 2022 devido à alta dos combustíveis. Atualmente, <strong>não há previsão de renovação</strong> desses pagamentos mensais para 2025 no orçamento federal.</p>
...
export const GuiaDireitosPage: React.FC<Props> = ({ onNavigate, quizzes }) => {
  useEffect(() => { document.title = "Guia de Direitos Sociais 2025: Cidadania"; }, []);
  return (
    <BroadcastLayout
      title="Seus Direitos em 2025: Guia completo de Cidadania"
...
export const CnhLegacyPage: React.FC<Props> = ({ onNavigate, quizzes }) => {
  useEffect(() => { document.title = "Regras CNH Social 2025: O que reprova?"; }, []);
  return (
    <BroadcastLayout
      title="Regras da CNH Social: O que pode reprovar sua inscrição em 2025?"
...
export const BolsaFamiliaLegacyPage: React.FC<Props> = ({ onNavigate, quizzes }) => {
  useEffect(() => { document.title = "Regras Bolsa Família 2025: Guia Detalhado"; }, []);
  return (
    <BroadcastLayout
