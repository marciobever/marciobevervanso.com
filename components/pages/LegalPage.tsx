      ...
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <section className="mb-12 border-b border-gray-200 pb-8">
           ...
           <div className="prose prose-slate max-w-none text-slate-600">
              <p className="text-lg leading-relaxed">
                 O <strong>Guia Social Brasil</strong> (marciobevervanso.com) nasceu com a missão de simplificar a burocracia estatal. Sabemos que entender as leis e regras dos benefícios sociais pode ser difícil, por isso traduzimos a linguagem oficial para algo que todo cidadão brasileiro possa compreender.
              </p>
              <p>
        ...
        <div className="prose prose-slate max-w-none text-sm text-slate-600">
           ...
           <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 mt-8">
              ...
              <p>
                 Para solicitar exclusão de dados de cookies, tirar dúvidas sobre privacidade ou entrar em contato com nossa equipe editorial, envie um email para: <strong>contato@marciobevervanso.com</strong>
              </p>
           </div>
        </div>
      </div>
