...
export const CardsNegativadoPage: React.FC<Props> = ({ onNavigate, onSimulate, quizzes }) => {
  // SEO Optimization
  useEffect(() => {
    document.title = "Cartão de Crédito para Negativado: Aprovando com Score Baixo | Lista 2025";
    
    const metaDesc = document.querySelector('meta[name="description"]');
    const desc = "Confira a lista de cartões de crédito que aprovam negativados em 2025. Sem consulta ao SPC/Serasa, limite inicial garantido e anuidade grátis.";
    if (metaDesc) {
