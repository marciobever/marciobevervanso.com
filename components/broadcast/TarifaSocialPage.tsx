...
export const TarifaSocialPage: React.FC<Props> = ({ onNavigate, onSimulate, quizzes }) => {
  useEffect(() => {
    document.title = "Tarifa Social de Energia 2025: Tabela de Descontos e Cadastro Automático";
    
    const metaDesc = document.querySelector('meta[name="description"]');
    const desc = "Saiba como conseguir até 65% de desconto na conta de luz com a Tarifa Social. Veja a tabela de consumo e quem tem direito automático.";
    if (metaDesc) {
