                   ...
                   <div className="grid grid-cols-2 gap-8">
                      ...
                      <div>
                         ...
                         <ul className="space-y-2">
                            ...
                            <li><a href="/cnh-social-2025" onClick={(e) => handleNav(e, 'landing-cnh')} className="block p-2 rounded-lg hover:bg-blue-50 text-sm font-medium text-slate-700 hover:text-brand-blue transition-colors">CNH Social Gratuita</a></li>
                         ...
                         <ul className="space-y-2 mb-6">
                            <li>
                               <a href="/calendarios" onClick={(e) => handleNav(e, 'calendarios')} className="flex items-center gap-3 p-2 rounded-lg hover:bg-green-50 group/item transition-colors">
                                  ...
                                  <span className="text-sm font-bold text-slate-700 group-hover/item:text-green-800">Calendários 2025</span>
                               </a>
                            </li>
                            <li>
              ...
              <div className="border border-gray-100 rounded-2xl overflow-hidden">
                 ...
                 {isBenefitsAccordionOpen && (
                    <div className="bg-white p-2 space-y-1">
                       ...
                       <a href="/calendarios" onClick={(e) => handleNav(e, 'calendarios')} className="block p-3 rounded-xl hover:bg-green-50 text-sm text-green-700 font-bold bg-green-50/30">📅 Calendários 2025</a>
