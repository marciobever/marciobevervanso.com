...
const ChatPage: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    { id: '1', role: 'model', content: 'Olá! Sou seu assistente virtual do Portal Marcio Bevervanso. Posso tirar dúvidas sobre Bolsa Família, CadÚnico, CNH Social e outros programas. O que você gostaria de saber hoje?' }
  ]);
